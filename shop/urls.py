...
urlpatterns = [
    ...
    path("shops/<int:shopId>/props/", views.getShopPropsFromShopId.as_view()),
    path("shops/props/", views.ShopPropsList.as_view()),
    path("shops/props/create/", views.ShopPropsCreate.as_view()),
    path("shops/props/<int:pk>/", views.ShopPropsDetail.as_view()),
